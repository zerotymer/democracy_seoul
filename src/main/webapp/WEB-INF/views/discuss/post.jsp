...
<body>
    ...
    <section class="inner">
        ...
        <div id="comments-pro" class="comments pro">
        	<c:forEach var="proComment" items="${pro}">
            <div class="comment pro">
                <div class="content">
                    <div class="text">${proComment.COMMENTCONTENT}</div>
                    <div class="id">${proComment.USERID}</div>
                </div>
                <div class="icon">
                	<div class="img">
                		<svg style="width:18px;height:18px" viewBox="0 0 24 24">
		...
		<c:forEach var="conComment" items="${con}">
            <div class="comment con">
                <div class="content">
                    <div class="text">${conComment.COMMENTCONTENT}</div>
                    <div class="id">${conComment.USERID}</div>
                </div>
                <div class="icon">
                	<div class="img">
                		<svg style="width:18px;height:18px" viewBox="0 0 24 24">
        ...
        <div class="more">
        	<button type="button" class="get" value="1"><i class="xi-caret-down-circle-o"></i>더보기</button>
        </div>
            ...
            if(result2){
                ...
                if(result){
                    ...
                    $.ajax({
            			url : "/discuss/vote.ajax",
            			type: "get",
            			data : {votePro:votePro,voteCon:voteCon+1,discussNo:discussNo},
            			success : function(data){
            				var json = JSON.parse(data);
            				voteCon++;
        					voteTotal++;
