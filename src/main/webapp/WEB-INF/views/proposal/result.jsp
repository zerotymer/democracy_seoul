...
<section>
            ...
            <div class="inner menubar">
                <ul>
                    ...
                    <li class="menubar-list">
                        <h3>결과보기<span class="slick-arrow"></span></h3>
    ...
    <div class="contents">
        ...
        <div class="navi-container">
            <ul class="navi--ul">
                <c:if test="${ preNavi > 0}">
                    <li class="navibtn pre"><a href='/proposal/allList.do?currentPage=${ preNavi }'><i
                            class='fas fa-chevron-left'> << </i></a></li>
                </c:if>
                <c:forEach items="${ navi }" var="i">
                    <c:choose>
                        <c:when test="${i==currentPage}">
                            <li class="navibtn active"><a href='/proposal/allList.do?currentPage=${i}'>${i}</a></li>
                        </c:when>
                        <c:otherwise>
                            <li class="navibtn"><a href='/proposal/allList.do?currentPage=${i}'>${i}</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                <c:if test="${ nextNavi > 0}">
                    <li class="navibtn next"><a href='/proposal/allList.do?currentPage=${ nextNavi }'><i
