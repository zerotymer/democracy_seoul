         ...
         <div class="notice-top">
         	 <div class="box-button">
				<button class="btn-notice">
					<a href="/board/noticeNewslist.do">자료실</a>
				</button>
			 </div>
		 </div>
	         ...
	         <div class="container">
			    <table>
			        ...
			        <tbody>		       				
			            <tr>
			                <td>(자료실 번호)</td>
			                <td><div class="text-ellipsis subject"><a href="/notice/noticeNewsSelectContent.do?noticeNo=(게시물고유번호)&currentPage=(최근페이지)">(자료실 제목)</a></div></td><!-- 누르면 이동하게 -->
			                <td>(조회수)</td>
			                <td>(작성일)</td>
			            </tr>
			        </tbody>
