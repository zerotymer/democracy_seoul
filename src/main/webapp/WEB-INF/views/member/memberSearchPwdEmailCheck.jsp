	...
	<div class="bg-color">
		<div class="box-white">
			...
			<form action="/member/goMemberSearchPwdResult.do" onsubmit="return Validation();" method="post">
					<span id="memberEmail">${sessionScope.member.email }</span>					 			
					...
					<input type="email" id="email" class="input-style" name="email" value="${sessionScope.member.email }" readonly><button type="button" onclick='sendEmail()'>인증메일 발송하기</button><br>	
